...
import com.example.wangpeijiang.zhihudemo.Utils.UtilTools;
import com.example.wangpeijiang.zhihudemo.view.Mainview;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by wangpeijiang on 2017/12/23.
 * 引导页
 */
...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstloadjudge(intent); // 调用 判断第一次app启动的方法

    }
    //判断第一次app启动的方法
    public void firstloadjudge(Intent it) {
...
//按钮事件
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_start:
            case R.id.iv_back:
                Intent intent = new Intent(this, Mainview.class);    //跳转设置
